...
export default function ProfileTabs({ userId, active }) {
  ...
  return (
    <div className="mt-4 md:mt-10 flex gap-0">
      <NavLink
        to=""
        className={active === "/profile" ? activeTabClasses : tabClasses}
      >
        <svg
      ...
      <Link
        to="about"
        className={active === "/profile/about" ? activeTabClasses : tabClasses}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
      ...
      <NavLink
        to="friends"
        className={
          active === "/profile/friends" ? activeTabClasses : tabClasses
        }
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <NavLink
        to="photos"
        className={active === "/profile/photos" ? activeTabClasses : tabClasses}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
